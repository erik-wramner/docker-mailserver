...
if [ -z "$IMAGE_NAME" ]; then
  if [ "$CRI" = "docker" ]; then
    IMAGE_NAME=erikwramner/docker-mailserver:latest
  elif [ "$CRI" = "podman" ]; then
    IMAGE_NAME=docker.io/erikwramner/docker-mailserver:latest
  fi
fi
...
OPTIONS:
  ...
  -i IMAGE_NAME     The name of the docker-mailserver image, by default
                    'erikwramner/docker-mailserver:latest' for docker, and
                    'docker.io/erikwramner/docker-mailserver:latest' for podman.
